...
export default function SocialLinks() {
  return (
    <div className="grid w-full grid-cols-3 divide-x divide-fuchsia-500/30 overflow-hidden rounded-xl border border-fuchsia-500/50 bg-zinc-950/60 shadow-[0_0_18px_rgba(217,70,239,0.2)]">
      {/* Cuadrado 1: GitHub */}
      <a
        href={GITHUB_URL}
        target="_blank"
        ...
        className="group flex aspect-square flex-col items-center justify-center gap-3 p-6 text-zinc-400 transition hover:bg-fuchsia-500/10 hover:text-fuchsia-300"
      >
        <span className="transition-transform group-hover:scale-110 group-hover:drop-shadow-[0_0_12px_rgba(217,70,239,0.7)]">
          <GitHubIcon />
        </span>
