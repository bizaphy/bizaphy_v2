...
// actual, escribimos su negacion, y retornamos para que el cliente sincronice.
export async function alternarDestacado(id: number): Promise<boolean> {
  const fila = await db
