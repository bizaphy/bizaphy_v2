      ...
      <div className="flex flex-col overflow-hidden rounded-md bg-zinc-900/60">
        ...
        <div className="p-3">
          {/* Parten arriba a la izquierda (content-start + justify-start),
              ...
              que en KanjiTrap. Alto fijo, ancho minimo igual al del orden de trazos: si los
              radicales no caben, el bloque crece hacia la derecha (max-w-full
              evita que se salga; en ese caso las tarjetas bajan de fila). */}
          <div
            className="flex h-72 min-w-72 max-w-full flex-wrap content-start items-stretch justify-start gap-3 overflow-hidden rounded bg-zinc-900/40 p-4 lg:h-80 lg:min-w-80"
          >
            {radicales.length > 0 ? (
