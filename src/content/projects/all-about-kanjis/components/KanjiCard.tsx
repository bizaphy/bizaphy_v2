...
export default function KanjiCard({
  ...
  const base =
    "group relative flex aspect-square items-center justify-center rounded-md border font-mono font-light text-[3.5rem] shadow-[0_0_6px_rgba(217,70,239,0.25)] transition-colors duration-150 ease-out select-none hover:z-10";
  const idle =
